<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="{{ url('css/styleUTS.css') }}">
	...
	<body>
		...
		<section class="header">
			...
			<div class="text-box">
				<h1>PT. Mayora Indah Tbk.</h1>
				<p>Satu Lagi dari Mayora!<br>Pelopor produk jajanan dengan inovasi untuk memberikan yang terbaik bagi semua orang </p>
				<a href="#sep" class="hero-btn">Klik Untuk Mulai Mengenali Kami</a> 	
			</div>
		</section>
